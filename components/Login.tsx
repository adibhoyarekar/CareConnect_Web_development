...
// Augment the JSX intrinsic elements so TypeScript accepts the <spline-viewer> element
declare global {
  namespace React.JSX {
...
export default function Login(props: LoginProps) {
  ...
  const inputContainerClasses = "relative mt-4";
  const inputBaseClasses = "w-full pl-10 pr-4 py-3 bg-white/20 border border-white/30 rounded-lg text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-transparent transition";
    ...
    <div className="relative min-h-screen flex items-center justify-center p-4 overflow-hidden bg-primary-950">
      ...
      >
        <div className="flex flex-col items-center text-center">
            <div className="w-24 h-24 -mt-20 mb-4">
            ...
            <h2 className="text-xl font-bold text-white mt-4">{isSignUp ? 'Create an Account' : 'Welcome Back'}</h2>
            <p className="text-gray-300 mt-2 text-sm">
                {isSignUp ? 'Already have an account? ' : "Don't have an account? "}
                <button onClick={() => setIsSignUp(!isSignUp)} className="text-primary-400 hover:underline font-semibold">
        ...
        <form className="mt-6" onSubmit={handleSubmit}>
            <AnimatePresence>
            {isSignUp && (
                <motion.div className="overflow-hidden" variants={inputVariants} initial="hidden" animate="visible" exit="exit">
            ...
            {isSignUp && (
                <motion.div className="overflow-hidden" variants={inputVariants} initial="hidden" animate="visible" exit="exit">
                    <div className="mt-4">
                        <label className="block text-gray-300 text-center text-sm">I am a...</label>
